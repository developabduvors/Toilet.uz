...
import { PrismaClient, LocationType, PriceType } from '@prisma/client';
...
const TASHKENT_LOCATIONS: SeedLocation[] = [
  ...
  },
  {
    ...
    type: LocationType.fuel, priceType: PriceType.free, priceAmount: 0,
  },
  {
    ...
    type: LocationType.fuel, priceType: PriceType.paid, priceAmount: 1000,
  },
  {
    name: 'Chorsu bozori jamoat hojatxonasi',
    address: 'Chorsu bozori, Eski shahar, Toshkent',
    latitude: 41.3267, longitude: 69.2362,
    type: LocationType.public, priceType: PriceType.paid, priceAmount: 1500,
  },
  {
  ...
  },
  {
    ...
    type: LocationType.mall, priceType: PriceType.paid, priceAmount: 3000,
  },
];
